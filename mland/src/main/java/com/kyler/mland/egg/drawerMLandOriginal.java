...
public class drawerMLandOriginal extends FrameLayout {
  ...
  private static final float CONTROLLER_VIBRATION_MULTIPLIER = 0f;
  ...
  public drawerMLandOriginal(Context context) {
    this(context, null);
  }

  public drawerMLandOriginal(Context context, AttributeSet attrs) {
    this(context, attrs, 0);
  }

  public drawerMLandOriginal(Context context, AttributeSet attrs, int defStyle) {
  ...
  private static class Player extends ImageView implements GameView {
    ...
    static Player create(drawerMLandOriginal land) {
